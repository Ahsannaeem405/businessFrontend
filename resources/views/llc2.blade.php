...
<style>
    ...
    .bor_rad2{
        border-radius: 10px 100px 100px 10px !important ;
    }
...
@include('slider')
<div class="container text-center pt-3 pb-5 pl-md-5 pr-md-5">
<h3>What is Lorem Ipsum?</h3>
<div class="row">
    <div class="col-md-6 col-12 p-2">
        <div class="box text-center p-3 bor_rad">
            <h3>What is Lorem Ipsum?</h3>
    ...
    <div class="col-md-6 col-12 p-2">
        <div class="box text-center p-3 bor_rad2">
            <h3>What is Lorem Ipsum?</h3>
            <h5>Lorem Ipsum is simply dummy text of the printing</h5>
            <a class="hs-button" href="#" target="_blank" rel="noopener" aria-label="This link will open in a new tab.">
                <span>Get started</span>
