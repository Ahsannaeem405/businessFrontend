...
<path fill="url(#bottom-right-transparent-green1_inline_svg__a)" fill-rule="evenodd" d="M720 0v720H0C0 322.355 322.355 0 720 0z"></path>
      ...
      <path d="M29 1.389c0 .746-.599 1.349-1.354 1.384a26.869 26.869 0 00-12.317 3.66C8.575 10.388 4.231 16.836 2.785 23.885A1.4 1.4 0 011.408 25c-.89 0-1.556-.806-1.38-1.666 1.599-7.79 6.398-14.916 13.863-19.286A29.704 29.704 0 0127.54.002C28.337-.036 29 .602 29 1.387v.002z" fill="#FD8550" fill-rule="evenodd"></path>
        ...
        <div class="comparison-chart-table__Content">
          <div class="white-box__Wrappergrid-table-row">
            <div class="grid-table-row__Cell">
              <p class="paragraph__StyledParagraph">{{$row2->Sub_heading}}</p>
            </div>
            <div class="grid-table-row__Cell">
                ...
                @endif
                                                                            ...
                                                                            <div class="accordion-panel " data-id="widget_1615203080926-statefilingfees2">
                                                                                <div class="comparison-chart-table__PanelWrapper">
                                                                                    <div class="comparison-chart-table__Grid-sc">
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row2->heading1}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row2->detail1}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row2->heading2}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row2->detail2}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row2->heading3}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row2->detail3}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row2->heading4}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row2->detail4}}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
        ...
        <div class="comparison-chart-table__Content">
          <div class="white-box__Wrappergrid-table-row">
            <div class="grid-table-row__Cell">
              <p class="paragraph__StyledParagraph">{{$row2->Sub_heading2}}</p>
            </div>
            <div class="grid-table-row__Cell">
                @if ($row2->status5==1)
                <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><path d="M10.328 15.84a.784.784 0 00-1.1 0 .763.763 0 000 1.089l3.889 3.846c.303.3.796.3 1.1 0l8.555-8.462a.763.763 0 000-1.088.784.784 0 00-1.1 0l-8.005 7.918-3.34-3.302z" id="circle-status-check_inline_svg__a"></path></defs><g fill="none" fill-rule="evenodd"><circle fill="#97E0C7" cx="16" cy="16" r="16"></circle><use stroke="#FFF" fill="#FFF" fill-rule="nonzero" xlink:href="#circle-status-check_inline_svg__a"></use></g></svg>
                ...
                @endif
                                                                            ...
                                                                            <div class="accordion-panel " data-id="widget_1615203080926-3">
                                                                                <div class="comparison-chart-table__PanelWrapper">
                                                                                    <div class="comparison-chart-table__Grid-sc">
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row2->heading5}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row2->detail5}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row2->heading6}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row2->detail6}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row2->heading7}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row2->detail7}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row2->heading8}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row2->detail8}}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
        ...
        <div class="comparison-chart-table__Content">
          <div class="white-box__Wrappergrid-table-row">
            <div class="grid-table-row__Cell">
              <p class="paragraph__StyledParagraph">{{$row3->Sub_heading}}</p>
            </div>
            <div class="grid-table-row__Cell">
                @if ($row3->status1==1)
                <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><path d="M10.328 15.84a.784.784 0 00-1.1 0 .763.763 0 000 1.089l3.889 3.846c.303.3.796.3 1.1 0l8.555-8.462a.763.763 0 000-1.088.784.784 0 00-1.1 0l-8.005 7.918-3.34-3.302z" id="circle-status-check_inline_svg__a"></path></defs><g fill="none" fill-rule="evenodd"><circle fill="#97E0C7" cx="16" cy="16" r="16"></circle><use stroke="#FFF" fill="#FFF" fill-rule="nonzero" xlink:href="#circle-status-check_inline_svg__a"></use></g></svg>
                ...
                @endif
                                                                            ...
                                                                            <div class="accordion-panel " data-id="widget_1615203080926-managingyourbusinessfees4">
                                                                                <div class="comparison-chart-table__PanelWrapper">
                                                                                    <div class="comparison-chart-table__Grid-sc">
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading1}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail1}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading2}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail2}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading3}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail3}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading4}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail4}}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
        ...
        <div class="comparison-chart-table__Content">
          <div class="white-box__Wrappergrid-table-row">
            <div class="grid-table-row__Cell">
              <p class="paragraph__StyledParagraph">{{$row3->Sub_heading2}}</p>
            </div>
            <div class="grid-table-row__Cell">
                ...
                @endif
                                                                            ...
                                                                            <div class="accordion-panel " data-id="widget_1615203080926-5">
                                                                                <div class="comparison-chart-table__PanelWrapper">
                                                                                    <div class="comparison-chart-table__Grid-sc">
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading5}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail5}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading6}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail6}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading7}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail7}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading8}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail8}}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
        ...
        <div class="comparison-chart-table__Content">
          <div class="white-box__Wrappergrid-table-row">
            <div class="grid-table-row__Cell">
              <p class="paragraph__StyledParagraph">{{$row3->Sub_heading3}}</p>
            </div>
            <div class="grid-table-row__Cell">
                @if ($row2->status9==1)
                <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><path d="M10.328 15.84a.784.784 0 00-1.1 0 .763.763 0 000 1.089l3.889 3.846c.303.3.796.3 1.1 0l8.555-8.462a.763.763 0 000-1.088.784.784 0 00-1.1 0l-8.005 7.918-3.34-3.302z" id="circle-status-check_inline_svg__a"></path></defs><g fill="none" fill-rule="evenodd"><circle fill="#97E0C7" cx="16" cy="16" r="16"></circle><use stroke="#FFF" fill="#FFF" fill-rule="nonzero" xlink:href="#circle-status-check_inline_svg__a"></use></g></svg>
                ...
                @endif
                                                                            ...
                                                                            <div class="accordion-panel " data-id="widget_1615203080926-6">
                                                                                <div class="comparison-chart-table__PanelWrapper">
                                                                                    <div class="comparison-chart-table__Grid-sc">
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading9}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail9}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading10}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail10}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading11}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail11}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading12}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail12}}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
        ...
        <div class="comparison-chart-table__Content">
          <div class="white-box__Wrappergrid-table-row">
            <div class="grid-table-row__Cell">
              <p class="paragraph__StyledParagraph">{{$row3->Sub_heading4}}</p>
            </div>
            <div class="grid-table-row__Cell">
                @if ($row3->status13==1)
                <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><path d="M10.328 15.84a.784.784 0 00-1.1 0 .763.763 0 000 1.089l3.889 3.846c.303.3.796.3 1.1 0l8.555-8.462a.763.763 0 000-1.088.784.784 0 00-1.1 0l-8.005 7.918-3.34-3.302z" id="circle-status-check_inline_svg__a"></path></defs><g fill="none" fill-rule="evenodd"><circle fill="#97E0C7" cx="16" cy="16" r="16"></circle><use stroke="#FFF" fill="#FFF" fill-rule="nonzero" xlink:href="#circle-status-check_inline_svg__a"></use></g></svg>
                ...
                @endif
                                                                            ...
                                                                            <div class="accordion-panel " data-id="widget_1615203080926-7">
                                                                                <div class="comparison-chart-table__PanelWrapper">
                                                                                    <div class="comparison-chart-table__Grid-sc">
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading13}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail13}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading14}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail14}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading15}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail15}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row3->heading16}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row3->detail16}}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
        ...
        <div class="comparison-chart-table__Content">
          <div class="white-box__Wrappergrid-table-row">
            <div class="grid-table-row__Cell">
              <p class="paragraph__StyledParagraph">{{$row4->Sub_heading}}</p>
            </div>
            <div class="grid-table-row__Cell">
                @if ($row4->status1==1)
                <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><path d="M10.328 15.84a.784.784 0 00-1.1 0 .763.763 0 000 1.089l3.889 3.846c.303.3.796.3 1.1 0l8.555-8.462a.763.763 0 000-1.088.784.784 0 00-1.1 0l-8.005 7.918-3.34-3.302z" id="circle-status-check_inline_svg__a"></path></defs><g fill="none" fill-rule="evenodd"><circle fill="#97E0C7" cx="16" cy="16" r="16"></circle><use stroke="#FFF" fill="#FFF" fill-rule="nonzero" xlink:href="#circle-status-check_inline_svg__a"></use></g></svg>
                ...
                @endif
                                                                            ...
                                                                            <div class="accordion-panel " data-id="widget_1615203080926-tax8">
                                                                                <div class="comparison-chart-table__PanelWrapper">
                                                                                    <div class="comparison-chart-table__Grid-sc">
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row4->heading1}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row4->detail1}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row4->heading2}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row4->detail2}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row4->heading3}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row4->detail3}}</p>
                                                                                        </div>
                                                                                        <div class="comparison-chart-table__Column">
                                                                                            <p class="p-to-heading__HeadingWrapper">{{$row4->heading4}}</p>
                                                                                            <p class="paragraph__StyledParagraph">{{$row2->detail4}}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
        ...
        <div class="comparison-chart-table__Content">
          <div class="white-box__Wrappergrid-table-row">
            <div class="grid-table-row__Cell">
              <p class="paragraph__StyledParagraph">{{$row4->Sub_heading2}}</p>
            </div>
            <div class="grid-table-row__Cell">
                @if ($row4->status5==1)
                <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><path d="M10.328 15.84a.784.784 0 00-1.1 0 .763.763 0 000 1.089l3.889 3.846c.303.3.796.3 1.1 0l8.555-8.462a.763.763 0 000-1.088.784.784 0 00-1.1 0l-8.005 7.918-3.34-3.302z" id="circle-status-check_inline_svg__a"></path></defs><g fill="none" fill-rule="evenodd"><circle fill="#97E0C7" cx="16" cy="16" r="16"></circle><use stroke="#FFF" fill="#FFF" fill-rule="nonzero" xlink:href="#circle-status-check_inline_svg__a"></use></g></svg>
               ...
               <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><circle fill="#F1A0A0" cx="16" cy="16" r="16"></circle><path d="M11.78 10.263L16 14.484l4.22-4.221a1 1 0 011.415 0l.102.102a1 1 0 010 1.414L17.516 16l4.221 4.22a1 1 0 010 1.415l-.102.102a1 1 0 01-1.414 0L16 17.516l-4.22 4.221a1 1 0 01-1.415 0l-.102-.102a1 1 0 010-1.414L14.484 16l-4.221-4.22a1 1 0 010-1.415l.102-.102a1 1 0 011.414 0z" fill="#FFF"></path></g></svg>
                @endif
                                                                            ...
                                                                            <div class="accordion-panel " data-id="widget_1615203080926-9">
                                                                                <div class="comparison-chart-table__Grid-sc">
                                                                                    <div class="comparison-chart-table__Column">
                                                                                        <p class="p-to-heading__HeadingWrapper">{{$row4->heading5}}</p>
                                                                                        <p class="paragraph__StyledParagraph">{{$row4->detail5}}</p>
                                                                                    </div>
                                                                                    <div class="comparison-chart-table__Column">
                                                                                        <p class="p-to-heading__HeadingWrapper">{{$row4->heading6}}</p>
                                                                                        <p class="paragraph__StyledParagraph">{{$row4->detail6}}</p>
                                                                                    </div>
                                                                                    <div class="comparison-chart-table__Column">
                                                                                        <p class="p-to-heading__HeadingWrapper">{{$row4->heading7}}</p>
                                                                                        <p class="paragraph__StyledParagraph">{{$row4->detail7}}</p>
                                                                                    </div>
                                                                                    <div class="comparison-chart-table__Column">
                                                                                        <p class="p-to-heading__HeadingWrapper">{{$row4->heading8}}</p>
                                                                                        <p class="paragraph__StyledParagraph">{{$row2->detail8}}</p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
        ...
        <div class="comparison-chart-table__Content">
          <div class="white-box__Wrappergrid-table-row">
            <div class="grid-table-row__Cell">
              <p class="paragraph__StyledParagraph">{{$row4->Sub_heading3}}</p>
            </div>
            <div class="grid-table-row__Cell">
                @if ($row4->status9==1)
                <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><path d="M10.328 15.84a.784.784 0 00-1.1 0 .763.763 0 000 1.089l3.889 3.846c.303.3.796.3 1.1 0l8.555-8.462a.763.763 0 000-1.088.784.784 0 00-1.1 0l-8.005 7.918-3.34-3.302z" id="circle-status-check_inline_svg__a"></path></defs><g fill="none" fill-rule="evenodd"><circle fill="#97E0C7" cx="16" cy="16" r="16"></circle><use stroke="#FFF" fill="#FFF" fill-rule="nonzero" xlink:href="#circle-status-check_inline_svg__a"></use></g></svg>
               ...
               <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><circle fill="#F1A0A0" cx="16" cy="16" r="16"></circle><path d="M11.78 10.263L16 14.484l4.22-4.221a1 1 0 011.415 0l.102.102a1 1 0 010 1.414L17.516 16l4.221 4.22a1 1 0 010 1.415l-.102.102a1 1 0 01-1.414 0L16 17.516l-4.22 4.221a1 1 0 01-1.415 0l-.102-.102a1 1 0 010-1.414L14.484 16l-4.221-4.22a1 1 0 010-1.415l.102-.102a1 1 0 011.414 0z" fill="#FFF"></path></g></svg>
                @endif
                                                                            ...
                                                                            <div class="accordion-panel " data-id="widget_1615203080926-10">
                                                                                <div class="comparison-chart-table__Grid-sc">
                                                                                    <div class="comparison-chart-table__Column">
                                                                                        <p class="p-to-heading__HeadingWrapper">{{$row4->heading9}}</p>
                                                                                        <p class="paragraph__StyledParagraph">{{$row4->detail9}}</p>
                                                                                    </div>
                                                                                    <div class="comparison-chart-table__Column">
                                                                                        <p class="p-to-heading__HeadingWrapper">{{$row4->heading10}}</p>
                                                                                        <p class="paragraph__StyledParagraph">{{$row4->detail10}}</p>
                                                                                    </div>
                                                                                    <div class="comparison-chart-table__Column">
                                                                                        <p class="p-to-heading__HeadingWrapper">{{$row4->heading11}}</p>
                                                                                        <p class="paragraph__StyledParagraph">{{$row4->detail11}}</p>
                                                                                    </div>
                                                                                    <div class="comparison-chart-table__Column">
                                                                                        <p class="p-to-heading__HeadingWrapper">{{$row4->heading12}}</p>
                                                                                        <p class="paragraph__StyledParagraph">{{$row2->detail12}}</p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            </div>
