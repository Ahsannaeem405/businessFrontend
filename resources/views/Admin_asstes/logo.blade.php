                ...
                <div class="table-responsive">
                    <table class="table zero-configuration">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$x}}</td>
                                <td><img src="{{asset('Upload/logo/'.$header->image)}}" style="max-height:100px;" alt=""></td>

                                <td>


                                    <a href="{{url('admin/edit_logo/'.$header->id)}}"  class="btn btn-primary ml-lg-1 ml-md-1 mt-1">Edit</a>
