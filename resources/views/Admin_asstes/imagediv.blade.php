                ...
                <div class="table-responsive">
                    <table class="table zero-configuration">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$x}}</td>
                                <td><img src="{{asset('Upload/launch/'.$header->image)}}" style="max-height:100px;" alt=""></td>
                                <td>{{$header->heading}}</td>
                                <td>


                                    <a href="{{url('admin/edit_launch/'.$header->id)}}"  class="btn btn-primary ml-lg-1 ml-md-1 mt-1">Edit</a>
    ...
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Add Launch Bussiness</h5>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary">Add Launch Business</button>
