...
<div class="card mt-2">
    ...
    <div class="card-header">
        <h4>Bussness Entity</h4>
    </div>
    <div class="card-content p-3">
        <form action="{{url('admin/update_whychoose')}}" method="POST" enctype="multipart/form-data">
            @csrf
         ...
         <div class="row p-3">
            ...
            <div class="col-lg-12 col-12 mt-2">
                ...
                <input name="file" type="file" data-default-file="{{asset('Upload/whychoose/'.$header->image)}}" class="dropify" data-height="100" />
            </div>
