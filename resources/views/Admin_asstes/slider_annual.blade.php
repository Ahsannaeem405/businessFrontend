                ...
                <div class="table-responsive">
                    <table class="table zero-configuration">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$x}}</td>
                                <td><img src="{{asset('Upload/annual/'.$header->image1)}}" style="max-height:100px;" alt=""></td>
                                <td>{{$header->heading}}</td>
                                <td>


                                    <a href="{{url('admin/edit_annualslider/'.$header->id)}}"  class="btn btn-primary ml-lg-1 ml-md-1 mt-1">Edit</a>
