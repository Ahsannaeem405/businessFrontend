...
<div class="card mt-2">
    ...
    <div class="card-content p-3">
        <form action="{{url('admin/update_launch')}}" method="POST" enctype="multipart/form-data">
            @csrf
         ...
         <div class="row p-3">
            ...
            <div class="col-lg-12 col-12 mt-2">
                ...
                <input name="file" type="file" data-default-file="{{asset('Upload/launch/'.$header->image)}}" class="dropify" data-height="100" />
            </div>
