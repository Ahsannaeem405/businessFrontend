    ...
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Employer Identification</h5>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary">Add Employer Identification</button>
