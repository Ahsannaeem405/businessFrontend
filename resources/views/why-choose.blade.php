                                                                ...
                                                                <svg viewbox="0 0 824 777"
                                                                    ...
                                                                    <defs>
                                                                        <radialgradient cx="0%" cy="100%" fx="0%"
                                                                            ...
                                                                            <stop stop-color="rgba(80, 137, 253,1.0)"
                                                                                offset="0%"></stop>
                                                                            <stop stop-color="rgba(224, 244, 253,1.0)"
                                                                                offset="100%"></stop>
                                                                        </radialgradient>
                                                                    </defs>
                                                                    <path
                                                            ...
                                                            <div class="banner-image-container">
                                                                <div class="gatsby-image-wrapper">
                                                                    <div class="gatsby-image-inner"
                                                                        style="padding-bottom:58.466%;"></div>
                                                                    <picture>

                                                                        <img src="{{asset('image/2.png')}}"
                                                                            alt="Why Choose Incfile" loading="lazy">
                                                                    </picture>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="banner-content page-center">
                                                                <div class="banner-content-inner">
                                                                    <div class="banner-content-container">
                                                                        <h1
                                                                            style="margin-bottom: 80px; max-width: 550px;">
                                                                            Lorem Ipsum</h1>
                                                                        ...
                                                                        <div class="banner-rating-container">
                                                                            ...
                                                                            <a href="https://www.shopperapproved.com/reviews/IncFile.com"
